...
class SmartPhone:
    ...
    def input_company_data(self): # 회사 입력
        # 사용자로부터 연락처 데이터를 입력받음
        print("# 데이터 2개를 입력합니다.")
        name = input("이름: ")
        phone = input("전화번호: ")
        ...
        return CompanyAddr(name, phone, email, address, group, 
            birth, company, section, position) # 주소값 리턴
    
    def input_customer_data(self): # 거래처 입력
        # 사용자로부터 연락처 데이터를 입력받음
        print("# 데이터 2개를 입력합니다.")
        name = input("이름: ")
        phone = input("전화번호: ")
        ...
        return CustomerAddr(name, phone, email, address, group, 
            birth, customer, item, position) # 주소값 리턴
